...
import { useGame, selectFace, selectMinesLeft } from './store';
import { BoardView } from './components/BoardView';
import { MenuBar } from './components/MenuBar';
import { CustomDialog, HelpDialog, OptionsDialog, RecordsDialog } from './components/Dialogs';
...
type DialogKind = 'custom' | 'records' | 'help' | 'options' | null;
